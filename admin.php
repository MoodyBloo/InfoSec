...
<body>
    ...
    <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
      <h1 class="display-4">Jobs Table</h1>
      <p class="lead">Access the Jobs Table through this webpage.</p>
    </div>

    <!--Content of the Page-->
    <div class="container">
        <button class="btn btn-primary my-5"><a href="userJobDesc.php" class="text-light">
            Add Student
        </a>
        </button>
                ...
                while($row=mysqli_fetch_assoc($result)){
                    ...
                    echo '<tr>
                            ...
                            <td>
                                ...
                                <button class="btn btn-danger"><a href="deleteJobDesc.php? deleteid='.$id.'" class="text-light">Delete</a></button>
                            </td>
                        </tr>';
                }
            }
