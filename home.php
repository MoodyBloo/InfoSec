...
<body>
    <div class="nav">
        ...
        $id = $_SESSION['id'];
        $query = mysqli_query($con,"SELECT * FROM users WHERE studentNumber=$studentNumber");
        ...
        while($result = mysqli_fetch_assoc($query)){
            ...
            $res_statusEnrolled = $result['statusEnrolled'];
        }
    ...
    <main>
        ...
        <div class="main-box top">
            <div class="top">
                ...
                <div class="box">
                    <p>Your Student Number is <b><?php $res_studentNumber; ?>.</p>
                </div>
            </div>
            <div class="bottom">
                <div class="box">
                    <p>And your course is <b><?php $res_studentNumber; ?></b>.</p>
                </div>
                <div class="box">
                    <p>And you are <b><?php $res_courseEnrolled; ?></b>.</p>
                </div>
            </div>
        </div>
